...
description: Geocortex Web - Learn about how components bind to models in the layout
---
...
:::note
Learn more about how [models are automatically matched](concepts-advanced-model-binding.mdx).
:::
