...
This is a reference for the attributes available to all components in an [app layout](configuration-layout-getting-started.mdx). Some of these attributes are accessible through the [Geocortex Web Designer](https://apps.geocortex.com/webviewer/designer/), and the rest must be configured through layout.
...
**Type**: `string`  
**Description**: A css selector string specifying the component with the model that needs to be resolved. See [models](configuration-layout-getting-started.mdx#models) for details.
...
:::tip
All of these components are available for use in the [Geocortex Web
...
Components support a number of presentation attributes to adjust their positioning and styling in the application after slotting. Some of these presentation attributes are accessible through the [Geocortex Web Designer](https://apps.geocortex.com/webviewer/designer/), and the rest can be configured through layout.
