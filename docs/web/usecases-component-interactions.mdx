...
Implementing a custom component in Geocortex Web gives you one of the highest degrees of flexibility with what you can do with Geocortex Web. Components can interact with other components and services, both built in and custom, which can allow complex application interactions to occur.
