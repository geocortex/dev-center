...
To allow layout to find your component, you need to add the [custom namespace](configuration-layout.mdx#namespaces) of your component defined in the previous step with an `xmlns` tag to the layout.'
