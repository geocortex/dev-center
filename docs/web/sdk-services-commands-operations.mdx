...
When writing custom services you may want to take advantage of Geocortex Web's large [built-in suite of command and operations](api-commands-operations.mdx) or your own [custom commands and operations](sdk-commands-operations.mdx#custom-commands-and-operations).
