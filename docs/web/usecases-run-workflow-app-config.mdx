...
Next, add a [app item](TODO-link-to-app-item) to the configuration for the map component, and configure the map to run `ui.display-notification` on initialization as a test.
