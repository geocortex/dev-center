...
The branding [service](concepts-components-services#services) is responsible for the theming of the application. To select a theme and accent color from within the config, you can configure the branding service in the [app config](concepts-app-config.mdx).
...
<!-- TODO - maybe this could be delegated to the API docs later, it it might have the BrandingColors object in it -->
...
<p>Here's <a href={useBaseUrl('img/action.svg')} download>a download link</a> for the svg representation of it.</p>

<!-- TODO - how to deploy icons -->
