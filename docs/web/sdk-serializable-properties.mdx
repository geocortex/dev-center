...
<UseCaseContainer>
    <UseCaseCard
        title="lang-component-configuration-reference"
        description="lang-component-configuration-reference-description"
        link={useBaseUrl(
            "docs/web/sdk-components-reference#configuration"
        )}
    />
    <UseCaseCard
        title="lang-service-configuration-reference"
        description="lang-service-configuration-reference-description"
        link={useBaseUrl(
