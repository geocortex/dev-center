...
:::important
Configuring a workflow to run when the map is initialized can be done through [Geocortex Web Designer](https://apps.geocortex.com/webviewer/designer/) and this is the preferred method of configuration if Designer can be used. The goal of this article is to demonstrate the pattern of overriding behaviors with workflows.
:::
...
<UseCaseContainer>
    <UseCaseCard
        title="lang-build-custom-form-title"
    ...
    <UseCaseCard
        ...
        description="lang-implement-custom-workflow-sdk-activity"
        link={useBaseUrl(
