...
:::important
Configuring a workflow to run when the map is initialized can be done through [VertiGIS Studio Web Designer](https://apps.geocortex.com/webviewer/designer/) and this is the preferred method of configurable if Designer can be used. The goal of this article is to demonstrate the pattern of overriding behaviors with workflows.
:::
