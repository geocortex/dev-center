...
We will start this example from the component and model built in the [previous example](usecases-implement-component-with-ui.mdx#example-rss-feed-of-news-updates).
