...
Next, we are going to create the [language resources](sdk-language-strings.mdx) for English and German.
...
Next we need to [register the language resources](sdk-language-strings.mdx#registering-language-resources) with Geocortex Web.
