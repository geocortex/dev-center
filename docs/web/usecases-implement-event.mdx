...
Events can only be published and subscribed to by [custom components](sdk-create-component.mdx) and [custom services](sdk-create-service.mdx), so it is suggested you learn the basics of building custom components before reading this article.
