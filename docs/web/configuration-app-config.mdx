...
While [layouts](configuration-layout.mdx) depict the visual structure of how components are going to appear in the viewer, **app config** is used to define the functional structure within a given component.
...
<UseCaseContainer>
    ...
    <UseCaseCard
        ...
        link="configuration-app-config-reference"
    />
    <UseCaseCard
