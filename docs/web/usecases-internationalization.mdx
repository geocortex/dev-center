...
:::tip
Geocortex Web comes with built in [support for full internationalization](https://docs.geocortex.com/webviewer/latest/admin-help/Default.htm#gwv/internationalization.htm). Existing language strings for an application can be customized for any language in the Geocortex Web Designer. 
:::

TODO - ask Michael about what is actually possible in Designer

## Overriding Existing Language Strings

TODO - ask Eric how far we want to go with this.
...
<layout xmlns="https://geocortex.com/layout/v1" xmlns:custom="your.custom.namespace">
    <map>
        <custom:translatable-text slot="top-center" width="15" height="3" padding="0.5"/>
    </map>
</layout>
```
