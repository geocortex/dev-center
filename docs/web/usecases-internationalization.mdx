...
Next, we are going to create the [language resources](TODO-link-language-resources) for English and German.
...
Next we need to [register the language resources](TODO-register-language-resources) with Geocortex Web.
