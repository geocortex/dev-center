...
[VertiGIS Studio Web](https://www.geocortex.com/products/gxw/) is a next-generation framework for creating sleek and effective GIS applications for a wide variety of browsers. Apps allow users to view and interact with web-based maps and associated data. VertiGIS Studio Web can seamlessly display both 2D and 3D map data. VertiGIS Studio Web is part of the [VertiGIS Studio suite of products](https://www.geocortex.com/products/).
