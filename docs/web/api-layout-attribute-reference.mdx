---
title: Layout Attribute Reference
description: Geocortex Mobile - Layout components attribute reference
---

This is a reference for the attributes available to all components in an [app layout](concepts-layout.mdx). Some of these attributes are accessible through the [Geocortex Web Designer](https://apps.geocortex.com/webviewer/designer/), and the rest must be configured through layout.
