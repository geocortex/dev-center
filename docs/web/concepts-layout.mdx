...
2. Tells the zoom widget to act upon [the map it is placed in](concepts-advanced-model-binding.mdx)
...
For a deeper dive into stacks and splits, [check out the API reference](concepts-layout-core-components.mdx#stacks-and-splits).
...
For more information on models, [check out the component SDK reference](sdk-component-reference.mdx#models) and this deeper dive into [model binding in the layout](concepts-advanced-model-binding.mdx).
