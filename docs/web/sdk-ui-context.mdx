...
First, every component has a [model](sdk-component-reference.mdx#models) which in turn has a `MessageBus` that can be used to access commands, operations, and events. All application context interactions can be facilitated by the model.
