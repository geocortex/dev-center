...
[Custom components](sdk-create-component.mdx) often need to access the application context to run [commands and operations](concepts-commands-operations.mdx), subscribe and publish to [events](sdk-events-overview.mdx), and more. A component has two ways of accessing the application context.
