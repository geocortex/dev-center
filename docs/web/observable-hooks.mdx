...
To make this easy, the functions in the [`@geocortex/web/ui/hooks`](TODO-api-link) are provided. The functions in this class watch properties on the model and allow you to either run a custom callback, or re-render the component.
