...
:::tip
To learn more about registering and using a component in the layout, check out [the component reference](TODO-component-reference-link)
:::
...
Next, we can inject the Map model, which is the type `MapExtension`, into the component using the [mode injection](TODO-link-model-injection) pattern.
