...
Next, add a [app item](TODO-link-to-app-item) to the configuration for the bookmarks component.
...
Finally, modify the `onClick` property of the bookmarks app item to be a custom action.
