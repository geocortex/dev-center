...
It's best practice to treat the components model as the source of the core business data backing the component, and let it manage data concerns and application interactions. This way, the React Component can simply manage presentation concerns regarding the models data.
.
