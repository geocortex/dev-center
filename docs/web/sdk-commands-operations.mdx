...
-   Built in components have properties in the app config which take a command or operation as values, allowing their internal a behavior to be configured.
...
<UseCaseContainer>
    <UseCaseCard
        ...
        link="usecases-run-command-with-button.mdx"
    />
    <UseCaseCard
