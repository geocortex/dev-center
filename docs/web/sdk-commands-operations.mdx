...
[Components](sdk-components-overview.mdx) or [services](sdk-services-overview.mdx) are usually responsible for registering a command or operation implementation with Geocortex Web. Once a command or operation has been registered, it can be used from anywhere in the application. Custom Commands and Operations are registered with custom services or custom components in this manner.
