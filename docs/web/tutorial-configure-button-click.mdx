...
<iframe
    src="https://codesandbox.io/embed/geocortex-web-configure-button-click-uv5fe?codemirror=1&editorsize=50&module=/app/layout.xml"
    style={{
        width: "100%",
        height: "500px",
        border: "0",
...
<TabItem value="ui">
<iframe
  src="https://codesandbox.io/embed/geocortex-web-configure-button-click-2-xo010?codemirror=1&editorsize=0&module=/app/layout.xml,/app/app.json"
...
<iframe
    src="https://codesandbox.io/embed/geocortex-web-configure-button-click-3-eyo70?codemirror=1&editorsize=50&module=/app/app.json,/app/layout.xml&highlights=10,11,12"
    style={{
        width: "100%",
        height: "500px",
        border: "0",
