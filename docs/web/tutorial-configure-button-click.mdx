...
:::note
It's possible to configure a button with a command in the [VertiGIS Studio Web Designer](https://apps.geocortex.com/webviewer/designer/). However, this tutorial demonstrates the concept of configuring behaviors using the app config directly.
:::
