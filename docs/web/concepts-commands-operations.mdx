...
:::tip
Checkout the [full list of built in commands and operations](TODO-link-commands-operations)
:::

Commands and operations are used to power much of Geocortex Web's built in behavior and interactions. They can be run through [configuration](TODO-link-to-basic-run-command-use-case), or through [custom services](TODO-link) or [components](TODO-link). They power everything from basic components like the IWTM, to advanced functionality like the results list.
