...
description: Geocortex Web - Configuring the application theme using app config
---
...
Geocortex Web's appearance is built around two concepts: theme and [layout](configuration-layout.mdx). The theme controls the color scheme of the app, while the layout controls the organization of content.
...
[customized](#customizing-theme-colors) and [used in custom components](sdk-component-styling.mdx)
