...
Geocortex Web's appearance is built around two concepts: theme and [layout](configuration-layout-getting-started.mdx). The theme controls the color scheme of the app, while the layout controls the organization of content.
