...
Events in components are accessed through the [UIContext](sdk-ui-context.mdx#accessing-the-uicontext).
...
:::tip
If you need to subscribe to events in a component, it's best practice to use the [component hooks](sdk-component-hooks.mdx) instead of a `useEffect`, as the component hooks will automatically clean up the event handle.
:::
