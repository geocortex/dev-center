...
:::tip
If you need to subscribe to events in a component, it's best practice to use the [component hooks](sdk-component-hooks) instead of a `useEffect`, as the component hooks will automatically clean up the event handle.
:::
