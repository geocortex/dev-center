...
Geocortex Web Components support fully custom styling using CSS. However, by using Geocortex Framework UI Elements, you can take advantage of styled, well tested, UI components that already participate in the [application theme](sdk-theme.mdx).
