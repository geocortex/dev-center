...
Geocortex Web Components support fully custom styling using CSS. However, by using Geocortex Framework UI Elements, you can take advantage of styled, well tested, UI components that already participate in the [application theme](usecases-look-and-feel.mdx).

:::tip
If manual CSS styling is required, you can still participate in the application theme by [using the theme colours defined in the `BrandingService`](usecases-look-and-feel.mdx#using-theme-colors-in-custom-components).
:::
