...
:::tip
Learn more about [implementing custom services](sdk-create-service.mdx)
:::
...
You can test your custom command and operation by adding entries to the I Want to Menu in the [app config](configuration-app-config.mdx) that run your commands and operation. For more information on customizing your app with commands and operations, see [commands and operations](configuration-commands-operations.mdx).
