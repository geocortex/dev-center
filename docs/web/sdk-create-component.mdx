...
> {
    ...
    // This method defines how the model will be serialized and deserialized into an app item.
    // We override it to include our new property `exampleValue`
...
<TabItem value="ui">
<img src={useBaseUrl("img/sdk-create-component.png")}/>
</TabItem>
</Tabs>
