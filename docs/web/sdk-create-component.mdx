...
The [Geocortex Web SDK](sdk-overview.mdx) project template includes an example of a [custom component](sdk-create-component.mdx) following our best practices. Creating a new custom component involves a few important steps:
...
Next we need to create the [component model](sdk-component-reference.mdx#models) that will be bound to the component we just created. This model will function as the underlying data source for the component.
