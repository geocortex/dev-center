...
The Geocortex SDK provides a development toolkit for building custom [components](usecases-implement-component-with-ui.mdx), [services](usecases-service-dynamic-data.mdx), and more into a package that can be deployed to Geocortex Web called a _library_. Once the _library_ has been developed, it can then be [deployed](sdk-deployment.mdx) to your SaaS or on-premises environment.
