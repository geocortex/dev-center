...
<UseCaseContainer>
    ...
    />
    <UseCaseCard
        title="Learn more about the Geocortex Web SDK Framework"
        description="Learn more about the Geocortex Web SDK framework and the various extension points"
        link="sdk-framework-overview"
    />
</UseCaseContainer>
