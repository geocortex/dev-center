...
:::tip
To learn more about registering and using a component in the layout, check out [the component reference](sdk-component-reference.mdx)
:::
...
Next, we can inject the Map model, which is the type `MapExtension`, into the component using the [model injection](sdk-component-interactions.mdx#interacting-with-components-through-models) pattern.
