...
The easiest way to deploy your custom library built using the SDK is to upload it to an application using the [VertiGIS Studio Web Designer](https://apps.geocortex.com/webviewer/designer/).
