...
Geocortex Web provides a number of [React hooks](https://reactjs.org/docs/hooks-intro.html) to ease development of custom components bound to [models](sdk-component-reference.mdx#models). These hooks make it simple to follow the recommended [observable properties pattern](https://developers.arcgis.com/javascript/latest/guide/programming-patterns/#properties) for model interactions within your functional components.
