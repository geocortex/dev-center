...
Every component is bound to specific [**item type**](configuration-app-config.mdx#anatomy-of-an-app-config), and each item type is bound to a specific model.
...
<UseCaseContainer>
    ...
    <UseCaseCard
        ...
        link="sdk-components-interactions"
    />
    <UseCaseCard
