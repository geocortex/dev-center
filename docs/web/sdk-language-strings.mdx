...
Geocortex Web was designed to be fully translatable on all levels of the product, from app config to custom code.

Language strings provide a couple advantages over hardcoding plain text in a component.
