...
Once a set of language strings has been registered, they can be used [in the app config](TODO-advanced-config-internationalization) or in [custom components](TODO-custom-components-internationalization).
