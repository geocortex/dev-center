...
:::tip
For a full example of a command with a dynamic execution status, [check out the `canExecute` tutorial](tutorial-can-execute.mdx), or [this live SDK sample](https://vertigis-web-samples.netlify.app/commands-and-operations).
:::
