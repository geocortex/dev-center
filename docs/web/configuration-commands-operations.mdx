...
Commands and operations are used to power much of Geocortex Web's built in behavior and interactions. They can be run through configuration, or through [custom services](sdk-services-overview.mdx) or [components](sdk-components-overview.mdx).
...
<UseCaseContainer>
    <UseCaseCard
        title="lang-commands-operations-events"
        description="lang-commands-operations-events-description"
    ...
    />
    <UseCaseCard
        title="lang-build-own-command-operation"
        description="lang-build-own-command-operation-description"
        link={useBaseUrl(
