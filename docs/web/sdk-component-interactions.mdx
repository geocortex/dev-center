...
Custom components can also import models and interact with them. The import must be done in the [model](TODO-model-link) of the component. This tight coupling can allow deeper access to other components models, but also negates the advantages of the abstraction of commands and operations.
