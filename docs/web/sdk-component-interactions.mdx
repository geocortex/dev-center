...
-   Using the `@importModel` decorator will tell the component to attempt to retrieve a reference to the given model type, according to the [model binding rules](api-component-models.mdx)
