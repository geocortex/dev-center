...
Many of the behaviors of Geocortex Web's built-in [components](sdk-components-overview.mdx) are configurable through the [app config](configuration-app-config.mdx).
...
Next, add a [app item](configuration-app-config.mdx#anatomy-of-an-app-config) to the configuration for the bookmarks component.
