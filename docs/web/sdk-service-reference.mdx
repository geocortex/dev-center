...
All services need to be registered with Geocortex Web. Services can optionally use the `itemType` property to bind to an [item in the app config](concepts-advanced-app-config.mdx#app-items).
