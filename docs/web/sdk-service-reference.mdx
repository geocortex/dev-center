...
Services are essentially a repository of globally accessible behavior and data, and can be used for a variety of purposes, from implementing commands and operations to managing shared data, to interfacing with the REST API of an external service. All services have access to initialization and cleanup methods, as well as the global message bus that allows for the registration and execution of commands and operations.
