...
For more information on models, [check out the component SDK reference](sdk-component-reference.mdx#models) and this deeper dive into [model binding in the layout](configuration-advanced-model-binding.mdx).
...
<UseCaseContainer>
    ...
    <UseCaseCard
        ...
        link="configuration-layout-reference#core-layout-components"
    />
    <UseCaseCard
