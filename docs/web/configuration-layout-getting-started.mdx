...
<UseCaseContainer>
    ...
    />
    <UseCaseCard
        title="lang-component-models"
        description="lang-component-models-description"
        link={useBaseUrl(
            "docs/web/configuration-advanced-model-binding"
        )}
    />
    <UseCaseCard
        title="lang-core-components"
        description="lang-core-components-description"
        link={useBaseUrl(
            "docs/web/configuration-layout-reference#core-layout-components"
        )}
    />
    <UseCaseCard
        title="lang-component-attributes"
        description="lang-component-attributes-description"
