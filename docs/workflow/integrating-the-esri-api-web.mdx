...
:::note
The `activity-sdk` uses the [ArcGIS API for JavaScript 3.x](https://developers.arcgis.com/javascript/3/) by default. See [Using Alternate ArcGIS API Versions](integrating-the-esri-api-web.mdx#using-alternate-esri-api-versions) for details.
:::
...
-   [Web App Builder](https://www.esri.com/en-us/arcgis/products/web-appbuilder/overview) - 3.x ArcGIS API for 2d View, 4.x
