...
:::note
This activity assumes that it will be running in Geocortex Web, and so [it uses the 4.x ArcGIS API for Javascript](sdk-web-integrating-the-arcgis-api.mdx#add-arcgis-api-for-javascript-typings).
:::
