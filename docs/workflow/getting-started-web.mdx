...
:::important
The activity pack will **not** be registered unless it includes the tag `geocortex-workflow-activity-pack`. The item must also be accessible to whichever group of users you want the activity pack to be accessible too.
:::

## Next Steps

<!-- TODO - these don't all make sense generically.... it's going to be different on web wab and GVH, this whole article might have to be rethought -->
