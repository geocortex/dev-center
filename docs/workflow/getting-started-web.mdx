...
The `dist` folder produced by running `npm run build` can be directly hosted with the webserver technology that is most appropriate for your use case, such as [IIS](https://www.iis.net/).
