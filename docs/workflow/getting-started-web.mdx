...
The Geocortex Workflow for Web Applications SDK consists of a TypeScript project that eases development of workflow activities and custom form elements. It produces a [workflow activity pack](concepts-activity-packs.mdx) that can be consumed by web applications that use workflow.
