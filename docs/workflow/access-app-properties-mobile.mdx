...
2. [Inject the class](../mobile/dependency-injection.mdx) into the [`IActivityHandlerFactory` for the application](implement-custom-activity-mobile#register-the-activity-with-the-iactivityhandlerfactory), and pass it to your custom activity's constructor.
