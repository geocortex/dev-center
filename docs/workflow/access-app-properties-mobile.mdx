...
2. [Inject the class](../mobile/dependency-injection.mdx) into the [`IActivityHandlerFactory` for the application](implement-custom-activity-mobile.mdx#register-the-activity-with-the-iactivityhandlerfactory), and pass it to your custom activity's constructor.
...
namespace App1.Workflow
{
    public class DisplayGeocortexMobileAlert : IActivityHandler
    {
        ...
        public static string Action { get; } = "custom:wf:app::DisplayGeocortexMobileAlert";
...
namespace App1.Workflow
{
    ...
    {
        public static string Action { get; } = "custom:wf:app::PlaceCalloutAtCenter";
