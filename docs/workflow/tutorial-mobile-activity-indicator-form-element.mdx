...
1. Create a new file `LoadingIndicator.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-getting-started.mdx).
...
1. Create a new file `FormElementRegistrationActivity.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-getting-started.mdx).
...
Learn more about [implementing custom activities](tutorial-mobile-calculate-logarithm-activity.mdx).
:::
