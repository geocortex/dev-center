...
[Custom Workflow activities](tutorial-web-calculate-logarithm-activity.mdx) implemented in [TypeScript](https://www.typescriptlang.org/) use [block tags](https://jsdoc.app/about-block-inline-tags.html) to describe the activity metadata that [Workflow Designer](https://apps.geocortex.com/workflow/designer/) consumes.
