...
1. [Follow these instructions](implement-custom-activity-web.mdx#set-up-activity-skeleton) to create a skeleton activity.
...
Learn more about [implementing custom activities](implement-custom-activity-web.mdx).
:::
