...
The following example declares that an activity will only work on Geocortex Web or Web AppBuilder in an online and client side environment. The display name will default to "Doesnt Work On Mobile".
