...
1. Create a new file `CustomFormElement` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-overview.mdx).
...
1. Create a new file `FormElementRegistrationActivity` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-overview.mdx).
