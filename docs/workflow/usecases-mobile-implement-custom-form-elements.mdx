...
1. Create a new file `CustomFormComponent` in the platform agnostic project of the Geocortex Mobile [quick start](../mobile/sdk-quick-start.mdx).
...
1. Create a new file `FormElementRegistrationActivity` in the platform agnostic project of the Geocortex Mobile [quick start](../mobile/sdk-quick-start.mdx).
...
This example demonstrates a form element that displays an enhanced activity indicator. [Check it out](https://github.com/geocortex/sdk-samples/workflow/custom-form-element) in the [Geocortex Mobile SDK Samples](../mobile/sdk-samples.mdx).
