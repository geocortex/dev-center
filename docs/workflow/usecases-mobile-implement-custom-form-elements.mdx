...
1. Create a new file `CustomFormComponent` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-quick-start.mdx).
  ...
  "forms": [
    {
      ...
      "elements": {
        "custom1": {
          "customType": "CustomFormComponent",
          "enabled": true,
          "index": 0,
          "title": { "markdown": "CustomFormComponent" },
          "type": "Custom"
        },
        "footer": {
          "enabled": true,
