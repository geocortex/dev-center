...
1. Create a new file `CustomFormComponent` in the platform agnostic project of the Geocortex Mobile [quickstart](../mobile/quick-start.mdx).
...
1. Create a new file `FormElementRegistrationActivity` in the platform agnostic project of the Geocortex Mobile [quickstart](../mobile/quick-start.mdx).
...
This example demonstrates a form element that displays an enhanced activity indicator. [Check it out](https://github.com/geocortex/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Workflow/CustomFormComponent) in the [Geocortex Mobile SDK Samples](../mobile/samples.mdx).
