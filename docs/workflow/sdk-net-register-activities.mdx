...
export class CalculateLog {
    ...
    async execute(inputs: CalculateLogInputs): Promise<CalculateLogOutputs> {
        ...
        throw new ActivityNotImplementedError(RunOperation.action);
    }
}
```
