...
Geocortex Workflow is built on the concept of [**workflows**](concepts-key-concepts.mdx#workflow). Workflows are a collection of connected **activities** and **forms**, and are created using Geocortex Workflow Designer.
