...
Geocortex Workflow is built on the concept of a [**workflow**](key-concepts.mdx#workflow). A workflow is a collection of connected **activities** and **forms**, that can be created using Geocortex Workflow Designer.
...
:::tip
[Explore the concepts](key-concepts.mdx) to learn more about activities, forms, the Geocortex Workflow Designer, and the cross-platform nature of Geocortex Workflow.
:::

## Explore the Tutorials

Check out the various tutorials to get started with extending Geocortex Workflow for your target [workflow host](key-concepts.mdx#geocortex-workflow-hosts).
