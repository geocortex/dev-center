...
1. Create a new file `CustomActivity` in the platform agnostic project of the Geocortex Mobile [quickstart](../mobile/quick-start.mdx).
...
The `ActivityLoader` registers the activity skeleton we created in it's constructor. Only one instance of the loader is required per Geocortex Mobile Application, as it can register multiple activities.
