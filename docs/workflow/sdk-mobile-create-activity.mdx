...
1. Create a new file `CustomActivity.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-getting-started.mdx).
...
<UseCaseContainer>
    <UseCaseCard
        ...
        link="tutorial-mobile-calculate-logarithm-activity"
    />
    <UseCaseCard
