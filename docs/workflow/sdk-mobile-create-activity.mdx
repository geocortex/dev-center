...
1. Create a new file `CustomActivity.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-overview.mdx).
...
:::tip
[Registering stubs for .NET activities](sdk-net-register-activities.mdx) provides a user friendly interface for your custom activities in Geocortex Workflow Designer.
:::

The [`RunActivity`](https://docs.geocortex.com/workflow/latest/help/Default.htm#wf5/help/activities/run-activity.htm%3FTocPath%3DActivities%7CActivity%2520Reference%7C_____167) activity can be used to execute your activity by the name defined in `CustomActivity.cs` (for this example, `uuid:<uuid>::CustomActivity`).
