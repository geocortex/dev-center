...
The `ActivityLoader` registers the activity skeleton we created by name in its constructor. Only one instance of the loader is required per Geocortex Mobile Application, as it can register multiple activities.
