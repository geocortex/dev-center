...
:::note
Depending on the type of host application different resources will be available. _For example, Web AppBuilder for ArcGIS is the only platform which has access to the `widget` property._
:::
