...
In the Geocortex Workflow JavaScript SDK, form elements are represented by Typescript React Components.
...
Learn more about [implementing custom activities](tutorial-web-calculate-logarithm-activity.mdx).
:::
