...
If you created a .NET Core project, Visual Studio will treat this as an Application and bundle both the user defined libraries and external libraries. This means that everything you need to copy exists in the built output folder. Follow the instructions to [Deploy the Activity](implement-custom-activity-server#deploy-the-activity).
