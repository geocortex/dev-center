...
Follow the instructions to [setup a new Geocortex Workflow Server extension project](getting-started-server.mdx#setting-up-a-geocortex-workflow-server-extension-project).
