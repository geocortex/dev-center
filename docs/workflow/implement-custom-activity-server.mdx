...
:::tip
If you want your custom activity to show up with a friendly user interface in Geocortex Workflow Designer, check out [Registering .NET Activities with Geocortex Workflow Designer](register-dotnet-activities-server.mdx).
:::
