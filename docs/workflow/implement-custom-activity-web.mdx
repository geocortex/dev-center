...
This article applies to any web application that [uses the TypeScript workflow runtime](concepts-key-concepts.mdx#geocortex-workflow-hosts), such as Geocortex Web, Geocortex Viewer for HTML5, and Web App Builder.
