...
For workflows targeting Web Applications like Geocortex Web, Geocortex Viewer for HTML or Web App Builder, activities are implemented in Typescript.
...
See the [SDK documentation](getting-started-web.mdx#building) for details.
