...
This article applies to any web application that uses the TypeScript workflow runtime, such as Geocortex Web, Geocortex Viewer for HTML5, and Web App Builder.
...
Now you know how to build a basic workflow activity for web applications. Next, you can learn how to use the Esri ArcGIS JS API in your activities, reference other third party libraries, build custom form elements, and more.

<UseCaseContainer>
    <UseCaseCard
        title="Use the Esri ArcGIS JS API in an activity."
        description="Use the Esri ArcGIS JS API in an activity or form element."
