...
1. Create a new file `CalculateLog.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-overview.mdx).
...
1. Create a new file, `ActivityLoader.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-overview.mdx).
