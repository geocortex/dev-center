...
1. Create a new file `CalculateLog.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-getting-started.mdx).
...
1. Create a new file, `ActivityLoader.cs` in the platform agnostic project of the Geocortex Mobile [Quickstart](../mobile/sdk-getting-started.mdx).
...
Now you can [build a workflow for Geocortex Mobile](https://docs.geocortex.com/mobileviewer/latest/admin-help/Default.htm#gmv/designer/add-a-workflow-to-an-app.htm) that uses your new activity!
...
<p>
    You can{" "}
    <a
        href={useBaseUrl("workflows/mobile-calculate-logarithm-activity.json")}
...
-   [Custom Workflow Activity](https://github.com/geocortex/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Workflow/CalculateLog)
...
<UseCaseContainer>
    <UseCaseCard
        ...
        description="Implement a custom form element for applications like Geocortex Mobile"
        link="tutorial-mobile-activity-indicator-form-element"
    />
    <UseCaseCard
        title="Add a Callout to the Map through a Custom Activity"
        description="Access the map in custom activities for Geocortex Mobile"
        link="tutorial-mobile-show-map-callout"
    />
    <UseCaseCard
        ...
        link="sdk-net-integrating-the-arcgis-api"
    />
    <UseCaseCard
        ...
        link="sdk-mobile-reference-third-party-library"
    />
</UseCaseContainer>
