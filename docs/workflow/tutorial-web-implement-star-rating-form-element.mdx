...
description: Geocortex Workflow - Implement a star rating form element for web applications
---
...
1. [Follow these instructions](sdk-web-create-activity.mdx) to create a skeleton activity.
...
Finally, we are going to expose the form elements value to the larger workflow. For more information on how to do this, check out the [relevant tutorial](tutorial-web-implement-star-rating-form-element.mdx).
