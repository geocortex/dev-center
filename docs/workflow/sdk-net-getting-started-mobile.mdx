...
The Geocortex Mobile SDK includes various [SDK Samples](../mobile/sdk-samples.mdx) for development, including ones like [this one](https://github.com/geocortex/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Workflow/CustomActivity) which demonstrate custom workflow functionality.
