...
Follow the instructions in [Implement a Custom Activity](usecases-web-implement-custom-activity.mdx) to create a custom workflow activity. You can then import ArcGIS API types with a `require` call.
