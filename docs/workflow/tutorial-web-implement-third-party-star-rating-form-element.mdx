...
description: Geocortex Workflow - Implement a star rating form element for web applications using a third party library
---
...
export class RegisterStarRatingElement extends RegisterCustomFormElementBase {
    ...
    static readonly action = "uuid:<uuid>::StarRating";
...
Once your activity pack is hosted and registered, your `Register StarRating Form Element` custom activity should appear in the activity toolbox in Geocortex Workflow Designer alongside the built-in activities.
