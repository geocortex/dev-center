...
description: Geocortex Workflow - Implement a QR code form element for web applications using a third party library
---
...
Once your activity pack is hosted and registered, your `Register QrCode Form Element` custom activity should appear in the activity toolbox in Geocortex Workflow Designer alongside the built-in activities.
...
<UseCaseContainer>
    <UseCaseCard
        title="lang-create-qr-activity-description"
        description="lang-create-qr-activity-description"
        link={useBaseUrl(
