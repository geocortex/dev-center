...
description: Geocortex Reporting - ArcGIS Notebook
---

You can use the **Geocortex Reporting Client for Python** package to run reports from ArcGIS Notebooks.

## Prerequisites

-   ArcGIS Online or ArcGIS Enterprise 10.7+
-   An ArcGIS user with permission to create and edit ArcGIS Notebooks
-   An existing Geocortex Report that accepts a `FeatureIds` parameter
