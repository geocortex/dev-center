...
2.  Run the report with a request to [/job/run](https://apps.geocortex.com/reporting/service/api-viewer/index.html?url=../swagger.json#/job/post_job_run).
    ...
    /_ cSpell:disable _/
    `json { "template": { "itemid": "5a810f3ac13454d6bfd2ac22ed0cc4b7", "portalUrl": "https://arcgis.com" }, "parameters": [...] }`
    /_ cSpell:enable _/ - Optional: Include an Authorization header with the token acquired in step 1
