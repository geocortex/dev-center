...
4. Use the ticket from the run request and the tag from the artifatcs request to download the completed report from [/job/result](https://apps.geocortex.com/reporting/service/api-viewer/index.html?url=../swagger.json#/job/get_job_result).
