...
:::note
Learn more of this ViewModel's use of the Geocortex Mobile helper class [`NotifyPropertyBase`](sdk-components-viewmodel-helper-class.mdx).
:::
...
<UseCaseContainer>
    <UseCaseCard
        title="lang-components-reference"
        description="lang-components-reference-description"
        link={useBaseUrl("docs/mobile/sdk-components-reference")}
    />
    <UseCaseCard
        title="lang-components-service-interactions"
        description="lang-components-service-interactions-description"
        link={useBaseUrl(
            "docs/mobile/sdk-component-service-interactions"
        )}
    />
    <UseCaseCard
        title="lang-implement-custom-service"
        description="lang-implement-custom-service-description"
