...
:::tip
The [Quickstart](sdk-getting-started.mdx) comes with a schema for `layout.xml` which can [autocomplete slot values for a component](concepts-advanced-layout.mdx#autocomplete-properties)
:::
