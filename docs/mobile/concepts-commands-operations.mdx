...
[Components or Services](concepts-components-services) are usually responsible for registering a command or operation with Geocortex Mobile. Once a command or operation has been registered, it can be used from anywhere in the application. [Custom Commands and Operations](implement-command-operation) are registered with [Custom Services](implement-service) or [Custom Components](implement-component-with-ui) in this manner.
