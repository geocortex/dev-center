...
:::note
If you do not provide a `config` attribute for a component, Geocortex Mobile will attempt to [infer a default value](configuration-advanced-layout.mdx#component-defaults).
:::
...
<UseCaseContainer>
    ...
    <UseCaseCard
        ...
        link="configuration-advanced-app-config"
    />
    <UseCaseCard
