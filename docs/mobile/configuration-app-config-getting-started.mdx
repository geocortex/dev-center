...
:::note
If you do not provide a `config` attribute for a component, Geocortex Mobile will attempt to [infer a default value](sdk-component-reference.mdx#component-defaults).
:::
