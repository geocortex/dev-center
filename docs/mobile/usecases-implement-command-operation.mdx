...
:::note
We never have to explicity set this property because of [Autofac autowiring](https://autofaccn.readthedocs.io/en/latest/register/prop-method-injection.html) configured in the assembly attribute.
:::
