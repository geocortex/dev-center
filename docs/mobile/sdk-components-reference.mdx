...
<UseCaseContainer>
    <UseCaseCard
        title="lang-commands-operations-with-components"
        description="lang-commands-operations-with-components-description"
        link={useBaseUrl("docs/mobile/sdk-commands-operations")}
    />
    <UseCaseCard
        title="lang-component-interactions"
        description="lang-component-interactions-description"
        link={useBaseUrl(
            "docs/mobile/sdk-component-service-interactions"
        )}
    />
    <UseCaseCard
        title="lang-create-complex-ui"
        description="lang-create-complex-ui-description"
        link={useBaseUrl(
            "docs/mobile/tutorial-implement-component-with-ui"
        )}
    />
    <UseCaseCard
        title="lang-create-component-consumes-app-config"
        description="lang-create-component-consumes-app-config-description"
        link={useBaseUrl(
