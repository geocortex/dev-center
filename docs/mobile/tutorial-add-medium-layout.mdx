...
The Geocortex Mobile [Quickstart](sdk-getting-started.mdx) comes with a [small and large layout](configuration-layout.mdx#device-form-factors). This tutorial will walk you through creating a medium form factor layout.
...
You now have a medium layout defined for your application. Learn more about how [layout](configuration-layout.mdx) works and customize this new layout to be optimized for a tablet screen size.
