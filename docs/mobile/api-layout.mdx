...
This is a reference for the attributes available to all components in an [app layout](concepts-layout.mdx). All components support these attributes, as well as any custom attributes the component defines.
