...
Sometimes, you may have logic or data that needs to be shared by multiple components across an app. In Geocortex Mobile, [services](configuration-components-services.mdx#services) are shared singletons that can register global [commands and operations](configuration-commands-operations.mdx), be injected into components, run background tasks, and more.
...
<UseCaseContainer>
    ...
    <UseCaseCard
        ...
        link="configuration-components-services#services"
    />
    <UseCaseCard
