...
We will modify the default search behavior of the [Quick Start](quick-start.mdx) application on the Fire Hydrants layer have have an optional filter that will only show fire hydrants without a hydrants survey.
