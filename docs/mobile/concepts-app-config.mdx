...
Check out the [Quickstart](quick-start.mdx) and [edit the default app config and layout](quick-start.mdx#editing-the-layout-and-app-config).
:::
...
:::note
This example uses [commands and operations](concepts-commands-operations.mdx) to power its behavior.
:::
