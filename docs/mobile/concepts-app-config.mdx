...
Check out the [Quick Start](quick-start) and [edit the default app config and layout](quick-start#editing-the-layout-and-app-config).
:::
...
:::note
If you do not provide a `config` attribute for a component, Geocortex Mobile will attempt to [infer a default value](concepts-advanced-layout#implicit-config-binding).
:::
...
<layout>
    <gxm:taskbar orientation="vertical" id="taskbar">
        <map id="map-primary" config="default" slot="main">
            ...
            <button icon="" config="openTaskbar" slot="bottom-center-visible" margin="0.5">Open Taskbar</button>
        </map>
    </gxm:taskbar>
</layout>
```
...
TODO - pretty mediocre example - get something meatier
...
```json
{
    "name": "App Config Sample",
    "settings": {
        "defaultVisibility": "true",
        "applicationName": "App Config Sample",
        "defaultWidth": 800,
        "defaultHeight": 600
    },
    "items": [
...
TODO - this will need rephrasing now that we have commands / operations in the examples
