...
:::note
If you do not provide a `config` attribute for a component, Geocortex Mobile will attempt to [infer a default value](concepts-advanced-layout.mdx#component-defaults).
:::
