...
-   An `IVoidOperation` produces no output, and optionally takes an input. This type represents a "command", as it **does not** produce an output.
...
-   An `IOperation` produces an output, and optionally takes an input. This type represents a "operation", as it **does** produce an output.
