...
The VertiGIS Studio Mobile Quickstart is simply a [.NET Xamarin Forms project](https://docs.microsoft.com/en-us/xamarin/get-started/Quickstarts/deepdive?pivots=windows) so you can add dependencies to it like any other .NET project.

:::caution
The VertiGIS Studio Mobile SDK relies on exact versions of [ArcGIS Runtime](https://developers.arcgis.com/arcgis-runtime/) and [Xamarin Forms](https://dotnet.microsoft.com/apps/xamarin/xamarin-forms) NuGet packages.
:::
