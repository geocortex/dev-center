...
-   `Geocortex Viewer Framework`
    -   This package provides the definitions of [layout](configuration-layout.mdx) and [app config](configuration-app-config.mdx) that are central to every Mobile app.
