...
Components express this data dependency through interactions [through injecting the `MapView`](sdk-component-service-interactions#interacting-with-the-mapview).
