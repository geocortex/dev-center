...
`IDisposableTracker` is also used when registering commands and operations, as described [here](sdk-commands-operations#direct-registration-and-implementation), and subscribing to events, described [here](sdk-events-reference#subscribing-to-events).
