...
Congradulations! You just created your first custom operation. You can easily test your new operation by setting it to [run it on map initialization](change-default-behaviour.mdx).
