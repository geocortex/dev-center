...
The ViewModel of the [Doomsday Cookie Clicker](http://localhost:3000/docs/mobile/implement-component-with-ui#example-doomsday-cookie-clicker) is a good example of this pattern.
