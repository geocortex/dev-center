...
:::note
It's actually possible to configure the a button with a command in [VertiGIS Studio Mobile Designer](https://apps.geocortex.com/webviewer/designer/). However, the point of this tutorial is to demonstrate the concept of configuring behaviors using the app config.
:::
