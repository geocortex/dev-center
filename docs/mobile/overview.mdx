...
Geocortex Mobile is a framework for configuring and building mobile offline-capable custom apps on Esris platform. Geocortex Mobile is part of the [Geocortex suite of products](https://www.geocortex.com/products/).
