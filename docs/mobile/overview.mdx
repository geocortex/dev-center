...
:::tip
[Explore the concepts](key-concepts.mdx) to learn more about how you can use the [layout](configuration-layout-getting-started.mdx) and [app config](configuration-app-config-getting-started.mdx) to create custom behavior and appearance.
:::
...
Use the [Geocortex Mobile SDK](sdk-overview.mdx) and [Geocortex Workflow SDK](../workflow/sdk-overview.mdx) to build completely custom UI and behavior.
...
<UseCaseContainer>
    <UseCaseCard
        ...
        link="../workflow/tutorial-mobile-implement-custom-form-elements"
    />
    <UseCaseCard
