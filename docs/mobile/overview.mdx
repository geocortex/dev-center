...
<UseCaseContainer>
    <UseCaseCard
        title="lang-layout-and-app-config"
        description="lang-layout-and-app-config-description"
        link={useBaseUrl("docs/mobile/key-concepts")}
    />
    <UseCaseCard
        title="lang-run-mobile-workflow"
        description="lang-run-mobile-workflow-description"
        link="https://docs.geocortex.com/mobileviewer/latest/admin-help/Default.htm#gmv/designer/add-a-workflow-to-an-app.htm"
    />
    <UseCaseCard
        title="lang-build-custom-workflow"
        description="lang-build-custom-workflow-description"
        link={useBaseUrl(
            "docs/mobile/tutorial-implement-custom-activity"
        )}
    />
    <UseCaseCard
        title="lang-mobile-sdk"
        description="lang-mobile-sdk-description"
