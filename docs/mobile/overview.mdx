...
Use the [Geocortex Mobile SDK](sdk-getting-started.mdx) and [Geocortex Workflow SDK](../workflow/sdk-mobile-overview.mdx) to build completely custom UI and behavior.
...
<UseCaseContainer>
    ...
    <UseCaseCard
        ...
        link="../workflow/tutorial-mobile-calculate-logarithm-activity"
    />
    <UseCaseCard
