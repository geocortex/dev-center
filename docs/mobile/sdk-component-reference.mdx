...
XAML views can use any [XAML Controls](https://docs.microsoft.com/en-us/xamarin/xamarin-forms/xaml/xaml-controls) along with built-in [Geocortex Mobile XAML Elements and styling](sdk-component-styling.mdx#using-geocortex-mobile-ui-elements).
