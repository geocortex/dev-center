...
Services are destroyed (i.e. the `_onDestroy` method is invoked) when the application is destroyed, e.g. when killing the application or switching applications in Geocortex Go.
