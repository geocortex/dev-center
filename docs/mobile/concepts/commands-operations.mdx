...
In Mobile, [Components or Services](/docs/mobile/concepts/components-services) are usually responsible for registering a Command/Operation with Mobile. Once a Command/Operation is registered, it can be used from anywhere in the application. [Custom Commands and Operations](/docs/mobile/use-cases/implement-command-operation) can be registered with [Custom Services](/docs/mobile/use-cases/implement-background-service) or [Custom Components](/docs/mobile/use-cases/implement-component-with-ui) in the same way.
...
<TabItem value="ui">
  <video loop muted controls>
    <source src="/video/commands-operations-demo.webm" type="video/webm"/>
...
:::tip 
Check out [Change Default Behaviour](/docs/mobile/use-cases/change-default-behaviour) for more ways to override default behaviour like a Map's on click event.  
:::
