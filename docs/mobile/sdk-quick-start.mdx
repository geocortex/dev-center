...
The [Geocortex Mobile quick start](../mobile/sdk-quick-start.mdx) is simply a [.NET Xamarin Forms project](https://docs.microsoft.com/en-us/xamarin/get-started/quickstarts/deepdive?pivots=windows) so you can add dependencies to it like any other .NET project.
...
The quick start is a useful starting point for your custom Geocortex Mobile application. Build on top of it by following along with a [use case](usecases-implement-command-operation.mdx), or check out the [SDK Samples](https://github.com/geocortex/mobile-sdk-samples) for inspiration and examples of what you can accomplish with the Geocortex Mobile SDK.
