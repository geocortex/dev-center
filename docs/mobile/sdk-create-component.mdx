...
If you can't solve your use case by editing the app layout and config using the [built in components](api-components.mdx), then it may be time to learn how to extend Geocortex Mobile with custom components. With custom components, you can create completely configurable UI and behaviour, interact with other components and built in services, and more.
...
<TabItem value="ui">
    <img src={useBaseUrl("img/mobile-sdk-create-component.png")} alt="Custom Component with Text Block"/>
</TabItem>
</Tabs>
...
<UseCaseContainer>
    ...
    <UseCaseCard
        ...
        link="concepts-components-services.mdx#components"
    />
    <UseCaseCard
