...
::important
One thing to note about this example is the use of `IDisposable` and `IDisposableTracker` to clean up event handlers in the View code behind and Service. Implementing these interfaces correctly is essentially to preventing [Memory Leaks in your Mobile Application](memory-leaks).
:::important
