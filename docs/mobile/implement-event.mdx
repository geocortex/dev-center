...
:::important
Check out [Implementing Custom Components](implement-custom-component-with-ui.mdx) and [Implementing a Custom Background Service](implement-service.mdx) before diving into this example
:::
