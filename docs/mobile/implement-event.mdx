...
:::important
Check out [Implementing Custom Components](implement-custom-component-with-ui) and [Implementing a Custom Background Service](implement-background-service) before diving into this example
:::
