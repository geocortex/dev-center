...
:::info
Geocortex Mobile has many built in [Events](concepts-events) that can be used to hook into various changes that occur in the application. Check out the [Events API](api-events) to see if the event you need already exists.
:::
...
:::important
If you haven't yet, check out [Implementing Custom Components](implement-custom-component-with-ui) and [Implementing a Custom Background Service](implement-background-service) before diving into this example 
:::
