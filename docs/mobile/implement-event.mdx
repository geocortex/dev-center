...
:::important
If you haven't yet, check out [Implementing Custom Components](/docs/mobile/implement-custom-component-with-ui) and [Implementing a Custom Background Service](/docs/mobile/implement-background-service) before diving into this example 
:::
