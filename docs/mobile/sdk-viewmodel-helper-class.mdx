...
The ViewModel of the [Doomsday Cookie Clicker](usecases-implement-component-with-ui.mdx#example-doomsday-cookie-clicker) is a good example of this pattern.
