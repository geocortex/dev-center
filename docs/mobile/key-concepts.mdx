...
App Config files describe component configuration and other values relevant to application behavior. An app config file is composed of a list of **app items**. App items can correspond to components in the layout, portal items, or any [other defined item type](configuration-advanced-app-config.mdx#custom-app-items).
