---
id: implement-component-participate-app-config
...
A component can optionally participate in the global app config. This allows multiple instances of the component to be configured in different ways, or for component behaviour to be changed without having to edit custom code.

## Prerequisites

Complete the previous use case, [Implement a Custom Component](implement-component-with-ui.mdx). This article will extend that component to consume custom app config.
...
Configuration can be defined in the [app json](quick-start.mdx#editing-the-layout-and-app-config) and linked to the component through the `config` attribute in layout, just like any other component.
...
<TabItem value="ui">
    <img src="/img/custom-configuration-final.png"/>
</TabItem>
</Tabs>
