...
Complete the previous use case, [Implement a Custom Component](implement-component-with-ui). This article will extend that component to consume custom app config.
...
Configuration can be defined in the [app json](quick-start#editing-the-layout-and-app-config) and linked to the component through the `config` attribute in layout, just like any other component.
