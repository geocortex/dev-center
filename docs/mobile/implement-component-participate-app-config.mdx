...
You've now created a custom component which consumes configuration values from the `app.json`. Using configuration in this manner allows you to make flexible, reusable components for your application.
