...
TODO - I don't like this ending sentence

You've now created a custom component which consumes configuration values from the `app.json`. Using configuration allows you to make flexible, resuable components for your application.

TODO - next steps here... check out the SDK sample for this? Custom Service?
