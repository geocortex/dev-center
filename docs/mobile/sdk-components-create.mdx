...
<UseCaseContainer>
    <UseCaseCard
        title="lang-create-custom-service"
        description="lang-create-custom-service-description"
        link={useBaseUrl("docs/mobile/sdk-services-create")}
    />
    <UseCaseCard
        title="lang-component-reference"
        description="lang-component-reference-description"
