...
```csharp title="App1/App1/components/ProgressBarComponent.cs"
using App1;
using App1.Components;
using Geocortex.Mobile.Composition.Layout;
using System.Xml.Linq;
...
```csharp title="App1/App1/components/ProgressBarComponentView.xaml.cs"
using App1.Components;
using Geocortex.Mobile.Composition;
...
```csharp title="App1/App1/components/ProgressBarComponentViewModel.cs"
using App1.Components;
using Geocortex.Mobile.Composition;
