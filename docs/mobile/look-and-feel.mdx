...
The theme controls the color scheme of the app. The color scheme for different themes is defined in branding component of the the [app config](concepts-app-config.mdx). This example is built around [editing the app json of the quickstart](quick-start.mdx#editing-the-layout-and-app-config) project.
