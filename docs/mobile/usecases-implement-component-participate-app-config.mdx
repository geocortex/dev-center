...
Configuration can be defined in the [app json](sdk-edit-layout-app-config.mdx) and linked to the component through the `config` attribute in layout, just like any other component.
