...
<UseCaseContainer>
    <UseCaseCard
        title="lang-service-create-custom-component"
        description="lang-service-create-custom-component-description"
        link={useBaseUrl("docs/mobile/sdk-components-create")}
    />
    <UseCaseCard
        title="lang-deploy-custom-layout-app-config"
        description="lang-deploy-custom-layout-app-config-description"
        link={useBaseUrl(
            "docs/mobile/sdk-deployment#deploying-app-config-and-layout"
        )}
    />
    <UseCaseCard
        title="lang-learn-more-layout-app-config"
        description="lang-learn-more-layout-app-config-description"
        link={useBaseUrl("docs/mobile/key-concepts")}
    />
    <UseCaseCard
        title="lang-explore-tutorials"
        description="lang-explore-tutorials-description"
        link={useBaseUrl(
