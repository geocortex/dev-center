...
-   When possible, interaction through [commands and operations](sdk-components-commands-operations.mdx#running-commands-and-operations) should be preferred, as this introduces the loosest coupling.
...
:::note
A layout model is resolved according to the [layout hierarchy](configuration-advanced-model-binding).
:::
