...
The theme controls the color scheme of the app. The color scheme for different themes is defined in branding component of the the [app config](concepts-app-config.mdx). This example is built around [editing the app json of the Quickstart](sdk-quick-start.mdx#editing-the-layout-and-app-config) project.
...
The branding component can be found and edited in the [`app.json`](sdk-quick-start.mdx#editing-the-layout-and-app-config).
