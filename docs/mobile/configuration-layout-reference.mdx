...
description: Geocortex Mobile - Layout Reference
---
...
This is a reference for the attributes available to all components in an app layout. All components support these attributes, as well as any custom attributes the component defines. Some of these attributes are accessible through the [Geocortex Mobile Designer](https://apps.geocortex.com/mobileviewer/designer/), and the rest be configured through layout.
...
:::tip
All of these components are available for use in the [Geocortex Mobile
Designer](https://apps.geocortex.com/mobileviewer/designer/).
:::
...
:::tip
The default `layout-large.xml` in the Geocortex Mobile [Quickstart](https://github.com/geocortex/vertigis-mobile-quickstart) has examples of multiple panels that live in the taskbar.
:::
...
Items that live in the sidebar can be defined within the taskbar component, and typically consist of Panels containing other contain, like the results list, or a workflow container.
...
Components support a number of presentation attributes to adjust their positioning and styling in the application after slotting. Some of these presentation attributes are accessible through the [Geocortex Mobile Designer](https://apps.geocortex.com/mobileviewer/designer/), and the rest must be configured through layout.
