...
This is a reference for the attributes available to all components in an app layout. All components support these attributes, as well as any custom attributes the component defines. Some of these attributes are accessible through the [VertiGIS Studio Mobile Designer](https://apps.geocortex.com/mobileviewer/designer/), and the rest can be configured through layout.
...
Components support a number of presentation attributes to adjust their positioning and styling in the application after slotting. Some of these presentation attributes are accessible through the [VertiGIS Studio Mobile Designer](https://apps.geocortex.com/mobileviewer/designer/), and the rest must be configured through layout.
