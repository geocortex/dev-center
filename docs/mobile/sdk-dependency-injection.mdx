...
Check out the VertiGIS Studio Mobile SDK Sample for [dependency injection](https://github.com/geocortex/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/Conceptual/DependencyInjection).
