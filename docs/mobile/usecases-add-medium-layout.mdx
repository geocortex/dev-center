...
The Geocortex Mobile [quick start](sdk-quick-start.mdx) comes with a [small and large layout](concepts-layout.mdx#device-form-factors). This use case will walk you through creating a medium form factor layout.
