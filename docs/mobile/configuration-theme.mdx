...
The VertiGIS Studio Mobile SDK Samples has an example of [configuring the theme with the branding service](https://github.com/geocortex/vertigis-mobile-samples/tree/master/Geocortex.Mobile.Samples/Geocortex.Mobile.Samples/Samples/AppConfiguration/Theme).
