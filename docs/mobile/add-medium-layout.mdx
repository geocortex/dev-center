...
The Geocortex Mobile [quick start](quick-start.mdx) comes with a [small and large layout](concepts-layout.mdx#device-form-factors). This use case will walk you through creating a medium form factor layout.
...
Add the new layout as an **app item** to the [`app.json`](quick-start.mdx#editing-the-layout-and-app-config) that references the medium layout.
