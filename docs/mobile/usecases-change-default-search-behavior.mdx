...
We will modify the default search behavior of the [Quickstart](sdk-quick-start.mdx) application on the Fire Hydrants layer to have an optional filter that will only show fire hydrants without a hydrants survey.
